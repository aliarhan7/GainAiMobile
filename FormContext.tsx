...
const submitToAPI = async () => {
    // Tum variablelari gerekli json objesine donusturup api'a submit etme fonksiyonu
    const data = {
        user,
        form,
        allergies,
    ...
    try {
        const res = await fetch('https://localhost:5000/saveUserMealPlan', {
        method: 'POST',
...
return (
    <FormContext.Provider value = {{user,form,allergies,updateUser,updateForm, updateAllergies}}>
      {children}
